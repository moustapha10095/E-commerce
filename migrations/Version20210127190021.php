 ...
 */
final class Version20210127190021 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE home_slider (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB NOT NULL COLLATE BINARY, button_message VARCHAR(255) NOT NULL COLLATE BINARY, button_url VARCHAR(255) NOT NULL COLLATE BINARY, image VARCHAR(255) NOT NULL COLLATE BINARY, is_display BOOLEAN DEFAULT NULL)');
        $this->addSql('DROP INDEX IDX_AB912789A76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__Cart AS SELECT id, user_id, reference, full_name, carrier_name, carrier_price, delivery_addresss, is_paid, more_informations, created_at, quantity, sub_total_ht, taxe, sub_total_ttc FROM "Cart"');
        $this->addSql('DROP TABLE "Cart"');
