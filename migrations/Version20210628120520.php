 ...
 */
final class Version20210628120520 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__order AS SELECT id, user_id, reference, full_name, carrier_name, carrier_price, delivery_addresss, is_paid, more_informations, created_at, quantity, sub_total_ht, taxe, sub_total_ttc, stripe_checkout_session_id FROM "order"');
        $this->addSql('DROP TABLE "order"');
        $this->addSql('CREATE TABLE "order" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, reference VARCHAR(255) NOT NULL COLLATE BINARY, full_name VARCHAR(255) NOT NULL COLLATE BINARY, carrier_name VARCHAR(255) NOT NULL COLLATE BINARY, carrier_price DOUBLE PRECISION NOT NULL, delivery_addresss CLOB NOT NULL COLLATE BINARY, is_paid BOOLEAN NOT NULL, more_informations CLOB DEFAULT NULL COLLATE BINARY, created_at DATETIME NOT NULL, quantity INTEGER NOT NULL, sub_total_ht DOUBLE PRECISION NOT NULL, taxe DOUBLE PRECISION NOT NULL, sub_total_ttc DOUBLE PRECISION NOT NULL, stripe_checkout_session_id VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_F5299398A76ED395 FOREIGN KEY (user_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO "order" (id, user_id, reference, full_name, carrier_name, carrier_price, delivery_addresss, is_paid, more_informations, created_at, quantity, sub_total_ht, taxe, sub_total_ttc, stripe_checkout_session_id) SELECT id, user_id, reference, full_name, carrier_name, carrier_price, delivery_addresss, is_paid, more_informations, created_at, quantity, sub_total_ht, taxe, sub_total_ttc, stripe_checkout_session_id FROM __temp__order');
        ...
        $this->addSql('ALTER TABLE product ADD COLUMN video CLOB DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__order_details');
        $this->addSql('CREATE INDEX IDX_845CA2C1CFFE9AD6 ON order_details (orders_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__product AS SELECT id, name, description, more_informations, price, is_best_seller, is_new_arrival, is_featured, is_special_offer, image, quantity, created_at, tags, slug FROM product');
        ...
        $this->addSql('INSERT INTO product (id, name, description, more_informations, price, is_best_seller, is_new_arrival, is_featured, is_special_offer, image, quantity, created_at, tags, slug) SELECT id, name, description, more_informations, price, is_best_seller, is_new_arrival, is_featured, is_special_offer, image, quantity, created_at, tags, slug FROM __temp__product');
